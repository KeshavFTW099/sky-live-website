...
export default function ProductDetailView({ product, category, onOpenContact, onBackToCategory, onBackToCategories }: any) {
                    ...
                    <tbody>
                      {Object.entries(specs).map(([key, val], sIdx) => (
                        <tr key={sIdx} style={{ borderBottom: '1px solid #ECECEC' }}>
                          ...
                          <td style={{ padding: '14px 0', fontSize: '14.5px', color: 'var(--text-secondary)' }}>{val as any}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
