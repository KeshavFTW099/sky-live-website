...
function HighlightCard({ item, gradClass, onClick }: any) {
...
export default function WhoWeAre({ highlights: propHighlights, description, mode, profileImage }: any) {
